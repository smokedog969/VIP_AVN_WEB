...
<div class="service" id="service">
    <div class="container">
        <div class="row">
            <div class="eight columns">
                <h1 class="service-title">PILOTS & CREW <strong>Service</strong></h1>
                <p>
                    We manage every aspect of your departure and arrival, together with your crew's total comfort and
                    convenience.
                    You and the crew will enjoy superior facilities in our lounge, which depending on the location,
                    complimentary Wi-Fi together with refreshments.
