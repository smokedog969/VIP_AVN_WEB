        ...
        <div class="row">
            ...
            <div class="six columns">
                ...
                <form class="contact-form" action="form.php" method="POST">
                    ...
                    <input name="name" id="contact-name" class="contact-input" placeholder="Your Name *" type="text"
                        required="required" />

                    <label for="contact-email" class="contact-label">Your E-Mail *</label>
                    <input name="email" id="contact-email" class="contact-input" placeholder="Your E-Mail *" type="text"
                        required="required" />
